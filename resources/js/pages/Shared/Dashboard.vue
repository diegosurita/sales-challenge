...
import type { AgCartesianAxisOptions, AgChartOptions } from 'ag-charts-community';
    ...
    <InternalBaseLayout title="Dashboard">
        <div class="flex flex-col gap-6">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                <div class="rounded-lg border border-slate-200 bg-white p-4">
                    <h2 class="mb-3 text-base font-semibold text-slate-800">Top 5 Products</h2>
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                <div class="rounded-lg border border-slate-200 bg-white p-4">
                    <h2 class="mb-3 text-base font-semibold text-slate-800">Top 5 Services</h2>
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b border-slate-200 text-left text-slate-500">
                                <th class="pb-2 font-medium">#</th>
                                <th class="pb-2 font-medium">Service</th>
                                <th class="pb-2 text-right font-medium">Times Sold</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr
